...
> Every screenshot here is the app's **demo mode** (`?demo=1`), which is why the yellow `DEMO`
> badge is in the corner and the data is fictional. Clone it and you get the same thing without
> any hardware.
