...
const LEAF_ICONS: Record<string, { active: string; inactive: string }> = {
  ...
  dsv4f: { active: 'icon_mb_dsv4f_active.png', inactive: 'icon_mb_dsv4f_inactive.png' },
  swarm: { active: 'icon_mb_swarm_active.png', inactive: 'icon_mb_swarm_inactive.png' },
  q38: { active: 'icon_qwen35_active.png', inactive: 'icon_qwen35_off.png' },
  q38h: { active: 'icon_qwen35_35b_active.png', inactive: 'icon_qwen35_35b_off.png' },
}
